...
<body>
 <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="https://getbootstrap.com/docs/4.1/examples/dashboard/#">CourseBoard</a>
...
<div class="container-fluid">
 ...
 <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
  <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
    <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
  </div>
  <div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div>
          ...
          <div class="card-group">
              ...
              <div class="card">
                <div class="card-body">
                   <div id="chart_div2" style="width: 500px; height: 280px"></div>
                </div>
              </div>
          ...
          <div class="card-group">
              ...
              <div class="card">
                <div class="card-body">
                   <div id="chart_div3" style="width: 330px; height: 280px"></div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                   <div id="chart_div4" style="width: 330px; height: 280px"></div>
                </div>
              </div>
            
              <div class="card">
                <div class="card-body">
                   <div id="chart_div5" style="width: 330px; height: 280px; margin-left: 50px"></div>
                </div>
              </div>
   ...
   <!--Carregando o AJAX API do Charts-->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
          ...
          var coloptions = {title:'1. Por favor, informe seu genêro.',bar: {groupWidth: "20%"},legend: { position: "none" }
      };
